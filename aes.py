#!/usr/bin/env python3
#references: https://github.com/boppreh/aes
"""
...
# Reference:  http://cs.ucsb.edu/~koc/cs178/projects/JT/aes.c
...
class AES:
    ...
    management. Please use `encrypt` and `decrypt` for using the encryption on your given string.
    """
